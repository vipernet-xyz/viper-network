...
import (
	...
	github_com_viper_network_viper_core_store_types "github.com/vipernet-xyz/viper-network/store/types"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type StoreCore struct {
	CommitID github_com_viper_network_viper_core_store_types.CommitID `protobuf:"bytes,2,opt,name=commitID,proto3,casttype=github.com/vipernet-xyz/viper-network/store/types.CommitID" json:"commitID"`
}
...
func (m *StoreCore) GetCommitID() github_com_viper_network_viper_core_store_types.CommitID {
	if m != nil {
		return m.CommitID
	}
	return github_com_viper_network_viper_core_store_types.CommitID{}
}
