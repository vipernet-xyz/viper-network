...
import (
	...
	"github.com/vipernet-xyz/viper-network/store/cachekv"
	serrors "github.com/vipernet-xyz/viper-network/store/errors"
...
type Store struct {
	...
	// By default this value should be set the same across all servicers,
	// so that servicers can know the waypoints their peers store.
	storeEvery int64
