...
func (cs *ClientState) VerifyClientMessage(
	ctx sdk.Ctx, cdc codec.BinaryCodec, clientStore sdk.KVStore,
...
func (cs *ClientState) verifyHeader(
	ctx sdk.Ctx, clientStore sdk.KVStore, cdc codec.BinaryCodec,
	header *Header,
) error {
...
func (cs ClientState) pruneOldestConsensusState(ctx sdk.Ctx, cdc codec.BinaryCodec, clientStore sdk.KVStore) {
