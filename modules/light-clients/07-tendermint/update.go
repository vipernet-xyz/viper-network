...
func (cs *ClientState) VerifyClientMessage(
	ctx sdk.Ctx, cdc *codec.Codec, clientStore sdk.KVStore,
...
func (cs *ClientState) verifyHeader(
	ctx sdk.Ctx, clientStore sdk.KVStore, cdc *codec.Codec,
	header *Header,
) error {
...
func (cs ClientState) pruneOldestConsensusState(ctx sdk.Ctx, cdc *codec.Codec, clientStore sdk.KVStore) {
