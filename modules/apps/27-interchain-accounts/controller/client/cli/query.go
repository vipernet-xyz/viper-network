...
func GetCmdQueryInterchainAccount() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: fmt.Sprintf("Viper Network query interchain-accounts controller interchain-account cosmos1layxcsmyye0dc0har9sdfzwckaz8sjwlfsj8zs connection-0"),
...
func GetCmdParams() *cobra.Command {
	cmd := &cobra.Command{
		...
		Args:    cobra.NoArgs,
		Example: fmt.Sprintf("Viper Network query interchain-accounts controller params"),
