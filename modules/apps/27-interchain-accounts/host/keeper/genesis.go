...
func InitGenesis(ctx sdk.Ctx, keeper Keeper, state genesistypes.HostGenesisState) {
...
func ExportGenesis(ctx sdk.Ctx, keeper Keeper) genesistypes.HostGenesisState {
