...
func GetRoutes() Routes {
	routes := Routes{
		...
		Route{Name: "QueryPlatform", Method: "POST", Path: "/v1/query/app", HandlerFunc: App},
		Route{Name: "QueryPlatformParams", Method: "POST", Path: "/v1/query/appparams", HandlerFunc: AppParams},
		Route{Name: "QueryPlatforms", Method: "POST", Path: "/v1/query/platforms", HandlerFunc: Platforms},
		...
		Route{Name: "QueryNode", Method: "POST", Path: "/v1/query/provider", HandlerFunc: Node},
		Route{Name: "QueryNodeClaim", Method: "POST", Path: "/v1/query/providerclaim", HandlerFunc: NodeClaim},
		Route{Name: "QueryNodeClaims", Method: "POST", Path: "/v1/query/providerclaims", HandlerFunc: NodeClaims},
		Route{Name: "QueryNodeParams", Method: "POST", Path: "/v1/query/providerparams", HandlerFunc: NodeParams},
