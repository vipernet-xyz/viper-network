...
type MsgServiceHandler = func(ctx sdk.Context, req sdk.Msg1) (*sdk.Result, error)

// Handler returns the MsgServiceHandler for a given msg or nil if not found.
func (msr *MsgServiceRouter) Handler(msg sdk.Msg1) MsgServiceHandler {
...
func (msr *MsgServiceRouter) RegisterService(sd *grpc.ServiceDesc, handler interface{}) {
	...
	for _, method := range sd.Methods {
		...
		msr.routes[requestTypeName] = func(ctx sdk.Context, req sdk.Msg1) (*sdk.Result, error) {
