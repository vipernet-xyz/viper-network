...
type MsgBeginUnstake struct {
	Address github_com_viper_network_viper_core_types.Address `protobuf:"bytes,1,opt,name=Address,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"application_address" yaml:"application_address"`
}
...
type MsgUnjail struct {
	AppAddr github_com_viper_network_viper_core_types.Address `protobuf:"bytes,1,opt,name=AppAddr,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"address" yaml:"address"`
}
