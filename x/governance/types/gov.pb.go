...
// source: x/governance/governance.proto
...
type MsgChangeParam struct {
	FromAddress github_com_viper_network_viper_core_types.Address `protobuf:"bytes,1,opt,name=fromAddress,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"address"`
...
func (m *MsgChangeParam) GetFromAddress() github_com_viper_network_viper_core_types.Address {
	if m != nil {
...
type MsgDAOTransfer struct {
	...
	Amount      github_com_viper_network_viper_core_types.BigInt  `protobuf:"bytes,3,opt,name=amount,proto3,customtype=github.com/vipernet-xyz/viper-network/types.BigInt" json:"amount"`
...
func (m *MsgDAOTransfer) GetFromAddress() github_com_viper_network_viper_core_types.Address {
	if m != nil {
		return m.FromAddress
	}
	return nil
...
func (m *MsgDAOTransfer) GetToAddress() github_com_viper_network_viper_core_types.Address {
	if m != nil {
		return m.ToAddress
	}
	return nil
...
func (m *MsgUpgrade) GetAddress() github_com_viper_network_viper_core_types.Address {
	if m != nil {
		return m.Address
	}
	return nil
...
type ACLPair struct {
	...
	Addr github_com_viper_network_viper_core_types.Address `protobuf:"bytes,2,opt,name=addr,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"address"`
}
...
func (m *ACLPair) GetAddr() github_com_viper_network_viper_core_types.Address {
	if m != nil {
		return m.Addr
	}
	return nil
