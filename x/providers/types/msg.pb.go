...
type MsgBeginUnstake struct {
	Address github_com_vipernet_xyz_viper_network_types.Address `protobuf:"bytes,1,opt,name=Address,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"provider_address" yaml:"provider_address"`
}
...
type MsgUnjail struct {
	ProviderAddr github_com_vipernet_xyz_viper_network_types.Address `protobuf:"bytes,1,opt,name=ProviderAddr,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"address" yaml:"address"`
}
...
func (this *MsgUnjail) GoString() string {
	...
	s = append(s, "AppAddr: "+fmt.Sprintf("%#v", this.ProviderAddr)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *MsgUnjail) String() string {
	...
	s := strings.Join([]string{`&MsgUnjail{`,
		`ProviderAddr:` + fmt.Sprintf("%v", this.ProviderAddr) + `,`,
		`}`,
	}, "")
	return s
}
