...
type GenesisState struct {
	...
	PrevStateValidatorPowers []PrevStatePowerMplatforming    `json:"prevState_validator_powers" yaml:"prevState_validator_powers"`
...
type PrevStatePowerMplatforming struct {
	Address sdk.Address
	Power   int64
}
