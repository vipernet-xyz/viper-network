...
var (
	MissingTokenVersionError           = errors.New("the provider authentication token version is missing")
	UnsupportedTokenVersionError       = errors.New("the provider authentication token version is not supported")
	...
	InvalidTokenSignatureErorr         = errors.New("the provider signature on the AAT is not valid")
	...
	InvalidTokenError                  = errors.New("the provider authentication token is invalid")
	...
	NotStakedBlockchainError           = errors.New("the blockchain is not staked for this provider")
	EmptyProviderPubKeyError           = errors.New("the public key of the provider is of Length 0")
	...
	MismatchedProviderPubKeyError      = errors.New("the provider public keys included in the proofs do not match")
