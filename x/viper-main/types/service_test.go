...
/*
	...
	exported2 "github.com/vipernet-xyz/viper-network/x/requestors/exported"
...
func TestRelay_Validate(t *testing.T) { // TODO add overservice, and not unique relay here
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			k2 := MockRequestorsKeeper{Requestors: []exported2.RequestorI{tt.app}}
			k3 := MockViperKeeper{}
...
func TestRelayResponse_BytesAndHash(t *testing.T) {
	...
	requestorSig, err := requestorPrivKey.Sign(relayResp.Proof.Token.Hash())
	if err != nil {
		t.Fatalf(err.Error())
	}
	relayResp.Proof.Token.RequestorSignature = hex.EncodeToString(requestorSig)
...
type MockRequestorsKeeper struct {
	Requestors []exported2.RequestorI
}

func (m MockRequestorsKeeper) GetStakedTokens(ctx sdk.Ctx) sdk.BigInt {
	panic("implement me")
}

func (m MockRequestorsKeeper) Requestor(ctx sdk.Ctx, addr sdk.Address) exported2.RequestorI {
	for _, v := range m.Requestors {
...
func (m MockRequestorsKeeper) AllRequestors(ctx sdk.Ctx) (requestors []exported2.RequestorI) {
	panic("implement me")
}

func (m MockRequestorsKeeper) TotalTokens(ctx sdk.Ctx) sdk.BigInt {
	panic("implement me")
}

func (m MockRequestorsKeeper) JailRequestor(ctx sdk.Ctx, addr sdk.Address) {
	panic("implement me")
}
...
func (m MockPosKeeper) RewardForRelays(ctx sdk.Ctx, relays sdk.BigInt, address sdk.Address, requestor requestorsType.Requestor) sdk.BigInt {
	panic("implement me")
}
