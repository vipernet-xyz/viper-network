...
type AAT struct {
	...
	RequestorPublicKey string `protobuf:"bytes,2,opt,name=requestorPublicKey,proto3" json:"requestor_pub_key"`
	ClientPublicKey   string `protobuf:"bytes,3,opt,name=clientPublicKey,proto3" json:"client_pub_key"`
	RequestorSignature string `protobuf:"bytes,4,opt,name=requestorSignature,proto3" json:"signature"`
}
...
func (this *SessionHeader) Equal(that interface{}) bool {
	...
	if this.RequestorPubKey != that1.RequestorPubKey {
		return false
	}
...
func (this *AAT) Equal(that interface{}) bool {
	...
	if this.RequestorPublicKey != that1.RequestorPublicKey {
		return false
	}
	if this.ClientPublicKey != that1.ClientPublicKey {
		return false
	}
	if this.RequestorSignature != that1.RequestorSignature {
		return false
	}
	return true
}
...
func (this *SessionHeader) GoString() string {
	...
	s = append(s, "RequestorPubKey: "+fmt.Sprintf("%#v", this.RequestorPubKey)+",\n")
...
func (this *AAT) GoString() string {
	...
	s = append(s, "RequestorPublicKey: "+fmt.Sprintf("%#v", this.RequestorPublicKey)+",\n")
	s = append(s, "ClientPublicKey: "+fmt.Sprintf("%#v", this.ClientPublicKey)+",\n")
	s = append(s, "RequestorSignature: "+fmt.Sprintf("%#v", this.RequestorSignature)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SessionHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RequestorPubKey) > 0 {
		i -= len(m.RequestorPubKey)
		copy(dAtA[i:], m.RequestorPubKey)
		i = encodeVarintVipernet(dAtA, i, uint64(len(m.RequestorPubKey)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *AAT) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RequestorSignature) > 0 {
		i -= len(m.RequestorSignature)
		copy(dAtA[i:], m.RequestorSignature)
		i = encodeVarintVipernet(dAtA, i, uint64(len(m.RequestorSignature)))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.RequestorPublicKey) > 0 {
		i -= len(m.RequestorPublicKey)
		copy(dAtA[i:], m.RequestorPublicKey)
		i = encodeVarintVipernet(dAtA, i, uint64(len(m.RequestorPublicKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Version) > 0 {
...
func (this *SessionHeader) String() string {
	...
	s := strings.Join([]string{`&SessionHeader{`,
		`RequestorPubKey:` + fmt.Sprintf("%v", this.RequestorPubKey) + `,`,
...
func (this *AAT) String() string {
	...
	s := strings.Join([]string{`&AAT{`,
		...
		`RequestorPublicKey:` + fmt.Sprintf("%v", this.RequestorPublicKey) + `,`,
		`ClientPublicKey:` + fmt.Sprintf("%v", this.ClientPublicKey) + `,`,
		`RequestorSignature:` + fmt.Sprintf("%v", this.RequestorSignature) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SessionHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestorPubKey", wireType)
			}
			...
			m.RequestorPubKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
...
func (m *AAT) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestorPublicKey", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RequestorPublicKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestorSignature", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RequestorSignature = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipVipernet(dAtA[iNdEx:])
