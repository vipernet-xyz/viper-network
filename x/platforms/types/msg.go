...
const (
	MsgPlatformStakeName   = "platform_stake"
	MsgPlatformUnstakeName = "platform_begin_unstake"
	MsgPlatformUnjailName  = "platform_unjail"
)
...
// ValidateBasic quick validity check for staking an platform
func (msg MsgStake) ValidateBasic() sdk.Error {
	if msg.PubKey == nil || msg.PubKey.RawString() == "" {
		return ErrNilPlatformAddr(DefaultCodespace)
	}
...
func (msg MsgStake) Type() string { return MsgPlatformStakeName }

// GetFee get fee for msg
func (msg MsgStake) GetFee() sdk.BigInt {
	return sdk.NewInt(PlatformFeeMap[msg.Type()])
}
...
// Type provides msg name
func (msg MsgBeginUnstake) Type() string { return MsgPlatformUnstakeName }
...
// Type provides msg name
func (msg MsgUnjail) Type() string { return MsgPlatformUnjailName }
...
func (msg MsgUnjail) GetSigners() []sdk.Address {
	return []sdk.Address{msg.PlatformAddr}
}
...
func (msg MsgUnjail) ValidateBasic() sdk.Error {
	if msg.PlatformAddr.Empty() {
		return ErrBadPlatformAddr(DefaultCodespace)
	}
	return nil
}
