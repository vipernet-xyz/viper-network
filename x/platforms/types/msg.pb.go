...
func (*MsgProtoStake) XXX_MessageName() string {
	return "x.platforms.MsgProtoStake"
}

type MsgBeginUnstake struct {
	Address github_com_viper_network_viper_core_types.Address `protobuf:"bytes,1,opt,name=Address,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"platform_address" yaml:"platform_address"`
}
...
func (*MsgBeginUnstake) XXX_MessageName() string {
	return "x.platforms.MsgBeginUnstake"
}

type MsgUnjail struct {
	PlatformAddr github_com_viper_network_viper_core_types.Address `protobuf:"bytes,1,opt,name=PlatformAddr,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"address" yaml:"address"`
}
...
func (*MsgUnjail) XXX_MessageName() string {
	return "x.platforms.MsgUnjail"
}
func init() {
	proto.RegisterType((*MsgProtoStake)(nil), "x.platforms.MsgProtoStake")
	proto.RegisterType((*MsgBeginUnstake)(nil), "x.platforms.MsgBeginUnstake")
	proto.RegisterType((*MsgUnjail)(nil), "x.platforms.MsgUnjail")
}

func init() { proto.RegisterFile("x/platforms/msg.proto", fileDescriptor_fd58e5eb64f87460) }
...
func (this *MsgUnjail) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.PlatformAddr, that1.PlatformAddr) {
		return false
	}
	return true
}
...
func (m *MsgUnjail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.PlatformAddr) > 0 {
		i -= len(m.PlatformAddr)
		copy(dAtA[i:], m.PlatformAddr)
		i = encodeVarintMsg(dAtA, i, uint64(len(m.PlatformAddr)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MsgUnjail) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PlatformAddr", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PlatformAddr = append(m.PlatformAddr[:0], dAtA[iNdEx:postIndex]...)
			if m.PlatformAddr == nil {
				m.PlatformAddr = []byte{}
			}
			iNdEx = postIndex
		default:
