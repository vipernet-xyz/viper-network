...
// source: x/vipercore/viper.proto
...
type MsgClaim struct {
	...
	FromAddress      github_com_viper_network_viper_core_types.Address `protobuf:"bytes,4,opt,name=fromAddress,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"from_address"`
...
func (*MsgProtoProof) XXX_MessageName() string {
	return "x.vipercore.MsgProtoProof"
}
...
type ChallengeProofInvalidData struct {
	...
	ReporterAddress   github_com_viper_network_viper_core_types.Address `protobuf:"bytes,3,opt,name=reporterAddress,proto3,casttype=github.com/vipernet-xyz/viper-network/types.Address" json:"reporters_address"`
}
...
func init() {
	proto.RegisterType((*SessionHeader)(nil), "x.vipercore.SessionHeader")
	proto.RegisterType((*Session)(nil), "x.vipercore.Session")
	proto.RegisterType((*MsgClaim)(nil), "x.vipercore.MsgClaim")
	proto.RegisterType((*MsgProtoProof)(nil), "x.vipercore.MsgProtoProof")
	proto.RegisterType((*ProofI)(nil), "x.vipercore.ProofI")
	proto.RegisterType((*ProtoEvidence)(nil), "x.vipercore.ProtoEvidence")
	proto.RegisterType((*RelayProof)(nil), "x.vipercore.RelayProof")
	proto.RegisterType((*ChallengeProofInvalidData)(nil), "x.vipercore.ChallengeProofInvalidData")
	proto.RegisterType((*RelayResponse)(nil), "x.vipercore.RelayResponse")
	proto.RegisterType((*AAT)(nil), "x.vipercore.AAT")
	proto.RegisterType((*MerkleProof)(nil), "x.vipercore.MerkleProof")
	proto.RegisterType((*Range)(nil), "x.vipercore.Range")
	proto.RegisterType((*HashRange)(nil), "x.vipercore.HashRange")
}

func init() { proto.RegisterFile("x/vipercore/viper.proto", fileDescriptor_fd7cbfa14fd73888) }
...
func (m *SessionHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SessionBlockHeight != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.SessionBlockHeight))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Chain) > 0 {
		i -= len(m.Chain)
		copy(dAtA[i:], m.Chain)
		i = encodeVarintViper(dAtA, i, uint64(len(m.Chain)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *Session) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SessionKey) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.SessionKey)))
		i--
		dAtA[i] = 0x12
	}
	{
...
func (m *MsgClaim) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExpirationHeight != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.ExpirationHeight))
		i--
		dAtA[i] = 0x30
	}
	if m.EvidenceType != 0 {
	...
	if len(m.FromAddress) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.FromAddress)))
		i--
		dAtA[i] = 0x22
	}
	if m.TotalProofs != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.TotalProofs))
		i--
		dAtA[i] = 0x18
	}
	{
...
func (m *ProtoEvidence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NumOfProofs != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.NumOfProofs))
		i--
		dAtA[i] = 0x18
	}
	...
	if len(m.BloomBytes) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.BloomBytes)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RelayProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Signature) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.Signature)))
		i--
		dAtA[i] = 0x3a
	}
	{
	...
	if len(m.Blockchain) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.Blockchain)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ServicerPubKey) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.ServicerPubKey)))
		i--
		dAtA[i] = 0x22
	}
	if m.SessionBlockHeight != 0 {
	...
	if m.Entropy != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.Entropy))
		i--
		dAtA[i] = 0x10
	}
	if len(m.RequestHash) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.RequestHash)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ChallengeProofInvalidData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReporterAddress) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.ReporterAddress)))
		i--
		dAtA[i] = 0x1a
	}
	{
...
func (m *RelayResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Response) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.Response)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Signature) > 0 {
...
func (m *AAT) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ClientPublicKey) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.ClientPublicKey)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if len(m.Version) > 0 {
		...
		i = encodeVarintViper(dAtA, i, uint64(len(m.Version)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MerkleProof) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TargetIndex != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.TargetIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Range) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Upper != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.Upper))
		i--
		dAtA[i] = 0x10
	}
	if m.Lower != 0 {
		i = encodeVarintViper(dAtA, i, uint64(m.Lower))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *HashRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Hash) > 0 {
		i -= len(m.Hash)
		copy(dAtA[i:], m.Hash)
		i = encodeVarintViper(dAtA, i, uint64(len(m.Hash)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintViper(dAtA []byte, offset int, v uint64) int {
	offset -= sovViper(v)
	base := offset
	for v >= 1<<7 {
...
func (m *MsgClaim) Size() (n int) {
	...
	n += 1 + l + sovViper(uint64(l))
	if m.TotalProofs != 0 {
		n += 1 + sovViper(uint64(m.TotalProofs))
	}
	l = len(m.FromAddress)
	if l > 0 {
		n += 1 + l + sovViper(uint64(l))
	...
	if m.ExpirationHeight != 0 {
		n += 1 + sovViper(uint64(m.ExpirationHeight))
	}
	return n
}
...
func (m *ProtoEvidence) Size() (n int) {
	...
	if m.NumOfProofs != 0 {
		n += 1 + sovViper(uint64(m.NumOfProofs))
	}
	if len(m.Proofs) > 0 {
...
func (m *MerkleProof) Size() (n int) {
	...
	_ = l
	if m.TargetIndex != 0 {
		n += 1 + sovViper(uint64(m.TargetIndex))
	}
	if len(m.HashRanges) > 0 {
...
func (m *Range) Size() (n int) {
	...
	_ = l
	if m.Lower != 0 {
		n += 1 + sovViper(uint64(m.Lower))
	}
	if m.Upper != 0 {
		n += 1 + sovViper(uint64(m.Upper))
	}
	return n
}
...
func sovViper(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozViper(x uint64) (n int) {
	return sovViper(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
...
func skipViper(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthViper
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupViper
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthViper        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowViper          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupViper = fmt.Errorf("proto: unexpected end of group")
)
