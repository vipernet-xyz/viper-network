...
func TestParseDenomTrace(t *testing.T) {
	testCases := []struct {
		...
		{"base denom", "uvipr", types.DenomTrace{BaseDenom: "uvipr"}},
		{"base denom ending with '/'", "uvipr/", types.DenomTrace{BaseDenom: "uvipr/"}},
		...
		{"trace info", "transfer/channel-1/uvipr", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/channel-1"}},
		{"trace info with custom port", "customtransfer/channel-1/uvipr", types.DenomTrace{BaseDenom: "uvipr", Path: "customtransfer/channel-1"}},
		{"trace info with base denom ending in '/'", "transfer/channel-1/uvipr/", types.DenomTrace{BaseDenom: "uvipr/", Path: "transfer/channel-1"}},
		...
		{"trace info with multiple port/channel pairs", "transfer/channel-1/transfer/channel-2/uvipr", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/channel-1/transfer/channel-2"}},
		{"trace info with multiple custom ports", "customtransfer/channel-1/alternativetransfer/channel-2/uvipr", types.DenomTrace{BaseDenom: "uvipr", Path: "customtransfer/channel-1/alternativetransfer/channel-2"}},
		{"incomplete path", "transfer/uvipr", types.DenomTrace{BaseDenom: "transfer/uvipr"}},
		{"invalid path (1)", "transfer//uvipr", types.DenomTrace{BaseDenom: "transfer//uvipr", Path: ""}},
		{"invalid path (2)", "channel-1/transfer/uvipr", types.DenomTrace{BaseDenom: "channel-1/transfer/uvipr"}},
		{"invalid path (3)", "uvipr/transfer", types.DenomTrace{BaseDenom: "uvipr/transfer"}},
		...
		{"invalid path (8)", "transfer/channelToA/uvipr", types.DenomTrace{BaseDenom: "transfer/channelToA/uvipr", Path: ""}},
	}
...
func TestDenomTrace_IBCDenom(t *testing.T) {
	testCases := []struct {
		...
		{"base denom", types.DenomTrace{BaseDenom: "uvipr"}, "uvipr"},
		{"trace info", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/channel-1"}, "ibc/C4CFF46FD6DE35CA4CF4CE031E643C8FDC9BA4B99AE598E9B0ED98FE3A2319F9"},
	}
...
func TestDenomTrace_Validate(t *testing.T) {
	testCases := []struct {
		...
		{"base denom only", types.DenomTrace{BaseDenom: "uvipr"}, false},
		...
		{"valid single trace info", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/channel-1"}, false},
		{"valid multiple trace info", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/channel-1/transfer/channel-2"}, false},
		{"single trace identifier", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer"}, true},
		{"invalid port ID", types.DenomTrace{BaseDenom: "uvipr", Path: "(transfer)/channel-1"}, true},
		{"invalid channel ID", types.DenomTrace{BaseDenom: "uvipr", Path: "transfer/(channel-1)"}, true},
...
func TestTraces_Validate(t *testing.T) {
	testCases := []struct {
		...
		{"valid multiple trace info", types.Traces{{BaseDenom: "uvipr", Path: "transfer/channel-1/transfer/channel-2"}}, false},
		{
			"valid multiple trace info",
			types.Traces{
				{BaseDenom: "uvipr", Path: "transfer/channel-1/transfer/channel-2"},
				{BaseDenom: "uvipr", Path: "transfer/channel-1/transfer/channel-2"},
			},
			true,
		},
...
func TestValidatePrefixedDenom(t *testing.T) {
	testCases := []struct {
		...
		{"prefixed denom", "transfer/channel-1/uvipr", false},
		{"prefixed denom with '/'", "transfer/channel-1/gamm/pool/1", false},
		{"empty prefix", "/uvipr", false},
		{"empty identifiers", "//uvipr", false},
		{"base denom", "uvipr", false},
		...
		{"invalid port ID", "(transfer)/channel-1/uvipr", true},
		{"empty denom", "", true},
...
func TestValidateIBCDenom(t *testing.T) {
	testCases := []struct {
		...
		{"base denom", "uvipr", false},
		{"base denom ending with '/'", "uvipr/", false},
