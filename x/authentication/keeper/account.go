...
// GetModuleAccountAndPermissions gets the module account from the authentication account store and its
...
// GetModuleAccount gets the module account from the authentication account store
...
// SetModuleAccount sets the module account to the authentication account store
