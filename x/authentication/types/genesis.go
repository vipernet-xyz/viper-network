...
// GenesisState - all authentication state that must be provided at genesis
...
// ValidateGenesis performs basic validation of authentication genesis data returning an
