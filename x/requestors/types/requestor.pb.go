...
// Requestor defines the total amount of bond shares and their exchange rate to
...
func (m *ProtoRequestor) Reset()      { *m = ProtoRequestor{} }
func (*ProtoRequestor) ProtoMessage() {}
func (*ProtoRequestor) Descriptor() ([]byte, []int) {
	return fileDescriptor_f9f7cb8e43f784d4, []int{0}
}
func (m *ProtoRequestor) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ProtoRequestor) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProtoRequestor.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *ProtoRequestor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ProtoRequestor.Merge(m, src)
}
func (m *ProtoRequestor) XXX_Size() int {
	return m.Size()
}
func (m *ProtoRequestor) XXX_DiscardUnknown() {
	xxx_messageInfo_ProtoRequestor.DiscardUnknown(m)
}

var xxx_messageInfo_ProtoRequestor proto.InternalMessageInfo
...
func init() {
	proto.RegisterType((*ProtoRequestor)(nil), "x.requestors.ProtoRequestor")
	proto.RegisterType((*Pool)(nil), "x.requestors.Pool")
}

func init() { proto.RegisterFile("requestors.proto", fileDescriptor_f9f7cb8e43f784d4) }
...
func (this *Pool) Description() (desc *github_com_gogo_protobuf_protoc_gen_gogo_descriptor.FileDescriptorSet) {
	return RequestorsDescription()
}
func RequestorsDescription() (desc *github_com_gogo_protobuf_protoc_gen_gogo_descriptor.FileDescriptorSet) {
...
func (this *ProtoRequestor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ProtoRequestor)
	if !ok {
		that2, ok := that.(ProtoRequestor)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ProtoRequestor) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 14)
	s = append(s, "&types.ProtoRequestor{")
...
func valueToGoStringRequestors(v interface{}, typ string) string {
...
func (m *ProtoRequestor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *ProtoRequestor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ProtoRequestor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i -= n1
	i = encodeVarintRequestors(dAtA, i, uint64(n1))
	i--
	dAtA[i] = 0x52
	if m.NumServicers != 0 {
		i = encodeVarintRequestors(dAtA, i, uint64(m.NumServicers))
		i--
		dAtA[i] = 0x48
	}
	if len(m.GeoZones) > 0 {
		for iNdEx := len(m.GeoZones) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRequestors(dAtA, i, uint64(len(m.GeoZones[iNdEx])))
			i--
			dAtA[i] = 0x42
		}
	}
	{
		...
		i = encodeVarintRequestors(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x3a
	{
	...
	if len(m.Chains) > 0 {
		for iNdEx := len(m.Chains) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintRequestors(dAtA, i, uint64(len(m.Chains[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	if m.Status != 0 {
		i = encodeVarintRequestors(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x20
	}
	if m.Jailed {
	...
	if len(m.PublicKey) > 0 {
		...
		i = encodeVarintRequestors(dAtA, i, uint64(len(m.PublicKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintRequestors(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintRequestors(dAtA []byte, offset int, v uint64) int {
	offset -= sovRequestors(v)
	base := offset
	for v >= 1<<7 {
...
func (m *ProtoRequestor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Status != 0 {
		n += 1 + sovRequestors(uint64(m.Status))
	}
	if len(m.Chains) > 0 {
	...
	if m.NumServicers != 0 {
		n += 1 + sovRequestors(uint64(m.NumServicers))
	}
...
func sovRequestors(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozRequestors(x uint64) (n int) {
	return sovRequestors(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (this *ProtoRequestor) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ProtoRequestor{`,
...
func valueToStringRequestors(v interface{}) string {
	rv := reflect.ValueOf(v)
	if rv.IsNil() {
		return "nil"
	}
...
func (m *ProtoRequestor) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowRequestors
			}
			if iNdEx >= l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: ProtoRequestor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ProtoRequestor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if byteLen < 0 {
				return ErrInvalidLengthRequestors
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipRequestors(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipRequestors(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowRequestors
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthRequestors
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupRequestors
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthRequestors        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowRequestors          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupRequestors = fmt.Errorf("proto: unexpected end of group")
)
