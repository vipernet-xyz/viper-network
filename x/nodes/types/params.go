...
const (
	...
	DefaultServicerStakeWeightCeiling   int64 = 60000000000
)
...
type Params struct {
	...
	StakeDenom                           string        `json:"stake_denom" yaml:"stake_denom"`                         // the monetary denomination of the coins in the network `uvip` or `uAtom` or `Wei`
	StakeMinimum                         int64         `json:"stake_minimum" yaml:"stake_minimum"`                     // minimum amount of `uvip` needed to stake in the network as a node
